...
1. The five-whys skill ran the smoke preset: a run directory under `.five-whys/` was created and expander agents were dispatched (one root agent, then three branch agents).
