...
| [round-3](round-3/design.md) | v0.3.0 checkout full run on "rated 7.4/10" | 7.4 (pre-rubric) | Fixes from `design.md` coded for 0.3.0; independent audit of the round-2 ledger and a scored quality baseline; no per-reason ledger |
